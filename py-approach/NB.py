...
g_recall = recall_score(y_test, y_pred, average='macro')
g_precision = precision_score(y_test, y_pred, average='macro')
...
b_done = time.time() - s
y_pred = blf.predict(X_test)
b_acc = accuracy_score(y_test, y_pred)
b_mse = mean_squared_error(y_test, y_pred)
b_recall = recall_score(y_test, y_pred, average='macro')
b_precision = precision_score(y_test, y_pred, average='macro')
...
filename1 = 'model/GaussianNB.sav'
filename2 = 'model/BernoulliNB.sav'

pickle.dump(clf, open(filename1, 'wb'))
pickle.dump(blf, open(filename2, 'wb'))
